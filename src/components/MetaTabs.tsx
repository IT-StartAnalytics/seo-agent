...
export default function MetaTabs({
  ...
  const tabBtn = (key: 'gen' | 'live', label: string, tip: string) => (
    <button
      onClick={() => setTab(key)}
      data-tip={tip}
  ...
  return (
    <div>
      <div className="mb-3 inline-flex rounded-full border border-black/10 dark:border-white/10 bg-card p-0.5 text-xs font-medium">
        {tabBtn('gen', t('metaGenerated'), 'Meta tags generated by the agent')}
        {tabBtn('live', t('metaLive'), 'Meta tags currently live on the site')}
      </div>
